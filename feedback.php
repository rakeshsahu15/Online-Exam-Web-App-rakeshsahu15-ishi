...
<a href="Rakesh.php" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">n@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		 <h4 style="font-family:'typo' "><strong>Students of CSIT</strong></h4>
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Naveen Kumar Vaishnav</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918770435933</h4>
		<h4 style="font-family:'typo' ">naveenvaishnav0306@gmail.com</h4>
    <hr>
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Jaydeep Yadav</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919179639187</h4>
		<h4 style="font-family:'typo' ">yadavjay374@gmail.com</h4></div></div>
		</p>
      </div>
